...
namespace Turnierverwaltung.Model.SpielerNS
{
    public class Handballspieler : Spieler
    {
        ...
        {
            return base.GetInformation();// + $"Wurfstärke: {AnzahlTore}\r\n\r\n";
        }
        ...
        public override void SelektionId(long id)
        {
            ...
            try
            {
                ...
                string selektionstring = $"SELECT S.ID, HD.ANZAHL_TORE, S.VORNAME, S.NACHNAME, S.MANNSCHAFT_ID, S.GEBURTSTAG FROM SPIELER S JOIN HANDBALLER_DETAILS HD ON S.ID = HD.SPIELER_ID WHERE S.ID = {id}";
        ...
        public override void Speichern()
        {
            ...
            string updateDetails = $"UPDATE HANDBALLER_DETAILS SET ANZAHL_TORE='{AnzahlTore}' WHERE SPIELER_ID='{Id}'";
